...
These installers use the `pip`_ tool to do this.  Pip is the standard
package installer for Python, `recommended <pypa recommended_>`_ by the
`Python packaging authority`_.  The installers will also install Pip for you,
if you don't have it (it comes by default with Python >= 3.4).
